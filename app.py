...
# STYLING GLOBAL AGAR PAS 1 LAYAR TANPA SCROLL
st.markdown("""
    <style>
    /* 1. Kurangi padding utama halaman */
    .block-container {
    ...
    /* 4. Formatting Tabel di Kolom Kanan agar ukuran sedang & pas dibaca */
    table {
...
# HEADER UTAMA RINGKAS
st.markdown("<h2 style='margin-bottom: 0px;'>Aplikasi Prediksi Diabetes - Algoritma Naive Bayes</h2>", unsafe_allow_html=True)
